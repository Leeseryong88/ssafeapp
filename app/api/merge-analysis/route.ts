...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await model.generateContent([
      {
        text: "다음은 여러 위험성평가표에서 선택된 항목들입니다. 이 항목들을 분석하여 하나의 통합된 위험성평가표로 만들어주세요. 위험요소의 비슷한 그룹끼리 묶어주고, 중복된 내용은 제거해서 제대로된 위험성평가표로 만들어주세요. 위험요소 부분은 서술형으로 작성하고, 중대성과 가능성은 1~5 척도로 표현해주세요. 선택된 항목들: " + selectedItems + " 다음과 같은 형식으로 HTML 테이블을 생성해주세요: <table border=\"1\" cellpadding=\"8\" cellspacing=\"0\" style=\"border-collapse: collapse; width: 100%;\"><thead><tr style=\"background-color: #f2f2f2;\"><th>위험 요소</th><th>중대성</th><th>가능성</th><th>위험도</th><th>대책</th></tr></thead><tbody><tr><td>위험 요소 1</td><td>1~5</td><td>1~5</td><td>높음/중간/낮음</td><td>대책 내용</td></tr></tbody></table> 다른 설명이나 형식적인 표현 없이 HTML 테이블만 제공해주세요. 코드 블록 마크다운(```html)을 사용하지 말고 순수 HTML만 반환해주세요. 한국어로 응답해주세요."
      },
    ]);
